...
IF OBJECT_ID('master.Maintenance_Plans_Master','U') IS NOT NULL
    DROP TABLE master.Maintenance_Plans_Master;
GO

CREATE TABLE master.Maintenance_Plans_Master
(
    Failure_Code_ID              NVARCHAR(20)      NOT NULL,
    Failure_Code                 NVARCHAR(20)      NOT NULL,
    ...
    CONSTRAINT PK_Maintenance_Plans_Master
